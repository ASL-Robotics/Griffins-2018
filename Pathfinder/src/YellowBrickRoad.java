...
public class YellowBrickRoad {
	...
	public static void main(String[] args) {
		...
		/*
		 * Waypoint[] points2A = new Waypoint[] { new Waypoint(0.495, 3.980, 0), new
		 * Waypoint(4.267, 7.028, 0) };
		 * 
		 ...
		 * Trajectory left2A = modifier2A.getLeftTrajectory(); Trajectory right2A =
		 * modifier2A.getRightTrajectory();
		 * 
		 ...
		 * 
		 * Waypoint[] points2B = new Waypoint[] { new Waypoint(0.495, 3.980, 0), new
		 * Waypoint(4.267, 1.186, 0) };
		 * 
		 ...
		 * Trajectory left2B = modifier2B.getLeftTrajectory(); Trajectory right2B =
		 * modifier2B.getRightTrajectory();
		 * 
		...
		/*
		 * Waypoint[] pointsAC = new Waypoint[] { new Waypoint(4.267, 7.028, 0), new
		 * Waypoint(7.116, 6.226, 0) };
		 * 
		 ...
		 * Trajectory leftAC = modifierAC.getLeftTrajectory(); Trajectory rightAC =
		 * modifierAC.getRightTrajectory();
		 * 
		 ...
		 * 
		 * Waypoint[] pointsAD = new Waypoint[] { new Waypoint(4.267, 7.028, 0), new
		 * Waypoint(7.116, 1.988, 0) };
		 * 
		 ...
		 * Trajectory leftAD = modifierAD.getLeftTrajectory(); Trajectory rightAD =
		 * modifierAD.getRightTrajectory();
		 * 
		 ...
		 * 
		 * Waypoint[] pointsBC = new Waypoint[] { new Waypoint(4.267, 1.186, 0), new
		 * Waypoint(7.116, 6.226, 0) };
		 * 
		 ...
		 * Trajectory leftBC = modifierBC.getLeftTrajectory(); Trajectory rightBC =
		 * modifierBC.getRightTrajectory();
		 * 
		 ...
		 * 
		 * Waypoint[] pointsBD = new Waypoint[] { new Waypoint(4.267, 1.186, 0), new
		 * Waypoint(7.116, 1.988, 0) };
		 * 
		 ...
		 * Trajectory leftBD = modifierBD.getLeftTrajectory(); Trajectory rightBD =
		 * modifierBD.getRightTrajectory();
		 * 
