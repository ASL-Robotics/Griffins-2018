 ...
 */
public class MotionProfileLine extends Command {

	public MotionProfileLine() {
	...
	protected void initialize() {
		Robot.drivetrain.initializeMotionProfile(Drivetrain.LeftMotionProfilesA.leftLine,
		Drivetrain.RightMotionProfilesA.rightLine);
