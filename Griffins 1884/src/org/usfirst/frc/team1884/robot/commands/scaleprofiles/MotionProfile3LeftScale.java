 ...
 *
 */
public class MotionProfile3LeftScale extends Command {

    public MotionProfile3LeftScale() {
 ...
 // Called just before this Command runs the first time
 	protected void initialize() {
 		Robot.drivetrain.initializeMotionProfile(Drivetrain.LeftMotionProfilesScale.left3C,
 				Drivetrain.RightMotionProfilesScale.right3C);
