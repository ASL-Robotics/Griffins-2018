 ...
 */
public class MotionProfile1D extends Command {
	...
	protected void initialize() {
		Robot.drivetrain.initializeMotionProfile(Drivetrain.LeftMotionProfilesA.left1D,
		Drivetrain.RightMotionProfilesA.right1D);
